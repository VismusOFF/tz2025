  ...
  <svg className="arrow-svg" width="48" height="20" viewBox="0 0 48 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0)">
      ...
      <g mask="url(#mask0)">
        ...
        <path className="arrow-stroke1" d="M34 0C34 5.52285 38.4771 10 44 10" stroke="#2E2D2B" strokeWidth="2" />
        <path className="arrow-stroke2" d="M33.875 20C33.875 14.4772 38.3521 10 43.875 10H44H-10" stroke="#2E2D2B" strokeWidth="2" />
      </g>
    </g>
    <defs>
      <clipPath id="clip0">
